...
appServices.service('plansFilterProvider', ['basicServerDataProvider', function (basicServerDataProvider) {
    ...
    //general connection purpose (for simple filter page) to connection params association
    var typeToParameters = {
        ...
        typeMax: [] //not used at the moment
    };
    ...
    this.getSpeedMin = function () {
        return plansFilter.speedMin;
    };
    ...
    this.getTypeToParameters = function () {
        return _.cloneDeep(typeToParameters);
    };
    //END getters
    ...
    this.setSpeedMin = function (speedMin) {
        plansFilter.speedMin = speedMin;
    };
    ...
    this.resetFilter = function () {
        plansFilter = {
            ...
            speedMin: defaultPlansFilterSettings.speedMin,
